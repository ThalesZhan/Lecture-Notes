...
\end{equation*}
with globally Lipschitz continuous $b,\sigma$, and we always assume $\bm{W}$ is independent of $\bm{Z}$. Let $h = T/N$ for a large $N \in \N$ and $t_k = kh$ for $k = 0,1,\cdots,N$. Construction $\{\bm{X}^h_k\}_{k=0}^N$ by setting $\bm{X}^h_0 = \bm{Z} \in L^2$ and
\begin{equation*}
